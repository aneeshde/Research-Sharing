...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { author: @paper.author, description: @paper.description, title: @paper.title }
    end
  ...
  test "should update paper" do
    put :update, id: @paper, paper: { author: @paper.author, description: @paper.description, title: @paper.title }
    assert_redirected_to paper_path(assigns(:paper))
  end
